    ...
    <main class="main ">
        <div class="container  sliderSection scale-up-ver-center">
            <section class="slider ">
                <img class="slider__border" src="https://pick-studio.pro/wp-content/uploads/2020/07/10.webp">
        ...
        <div class="flagTitle">
           ...
           <h1> <?php the_field('logo_subtitle'); ?> - <span
                    class="logo_title"><?php the_field('main_motto'); ?></span>! </h1>
        </div>
